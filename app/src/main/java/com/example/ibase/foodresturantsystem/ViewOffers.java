...
public class ViewOffers extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        shr= PreferenceManager.getDefaultSharedPreferences(ViewOffers.this);

        hotelid=shr.getString("userid", "");

        try {
            Toast.makeText(ViewOffers.this, ""+hotelid, Toast.LENGTH_LONG).show();
           GetMenu opd= new GetMenu();
            ...
            Toast.makeText(ViewOffers.this, ""+e, Toast.LENGTH_SHORT).show();
        }
        ...
        lst.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, final int i, long l) {
                ...
                AlertDialog.Builder alertDialog = new AlertDialog.Builder(ViewOffers.this);
                ...
                alertDialog.setPositiveButton("Update",
                        new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialog,int which) {
                                ...
                                Intent i1=new Intent(ViewOffers.this,UpdateOffer.class);
                               ;
                                i1.putExtra("offer",offer[i]);
                                i1.putExtra("menuid",menuid[i]);

                                startActivity(i1);
                                Toast.makeText(ViewOffers.this, "Update here", Toast.LENGTH_SHORT).show();
                            }
                        });
                ...
                alertDialog.setNegativeButton("No",
                        new DialogInterface.OnClickListener() {
                            public void onClick(DialogInterface dialog, int which) {
                                ...
                                Toast.makeText(ViewOffers.this, "Not Update Till", Toast.LENGTH_SHORT).show();
                                finish();
                            }
                        });
    ...
    private class GetMenu extends AsyncTask<String, Integer, String> {
        ...
        protected void onPreExecute() {
            progress = ProgressDialog.show(ViewOffers.this, null,
                    "Generating Menu...");
        ...
        protected void onPostExecute(String result) {
            ...
            try {
                ...
                Toast.makeText(ViewOffers.this, "No records Found" + e, Toast.LENGTH_SHORT).show();
            }


            try{

                LevelAdapteroffer adapter=new LevelAdapteroffer(ViewOffers.this,itemname,offer);
