...
public class LevelAdapteraddtocard extends ArrayAdapter<String> {
	private final Activity context;
	private final String[] cost;
	private final String[] itemname;
	private final String[] hotle_name;
	CardView cardView;
	public LevelAdapteraddtocard(Activity context, String[] cost, String[] itemname, String[] hotelname) {
		super(context, R.layout.levellistaddtocart, cost);
	...
	public View getView(int position,View view,ViewGroup parent) {
		...
		View rowView=inflater.inflate(R.layout.levellistaddtocart, null,true);
