...
public class LevelAdapteroffer extends ArrayAdapter<String> {
	private final Activity context;
	private final String[] cost;
	private final String[] itemname;
	CardView cardView;
	public LevelAdapteroffer(Activity context, String[] cost,  String[] itemname) {
		super(context, R.layout.levellistoffer, cost);
	...
	public View getView(int position,View view,ViewGroup parent) {
		...
		View rowView=inflater.inflate(R.layout.levellistoffer, null,true);
